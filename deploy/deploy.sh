...
apply_knobs() { # apply_knobs FILE
  ...
  # Anty-koncentracja: jedno auto-wejście celuje w ~25% konta, więc gotówka
  # rozkłada się na ~4 najlepsze nazwy zamiast wpaść w jedną (sufit = max_position_pct).
  setenv AUTO_DEPLOY_MAX_POSITION_PCT 25.0 "$f"
